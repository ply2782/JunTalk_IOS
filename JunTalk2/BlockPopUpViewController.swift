//
//  BlockPopUpViewController.swift
//  JunTalk2
//
...
class BlockPopUpViewController: UIViewController {
...
extension UIViewController {
    func showPopUp(title: String? = nil,
        ...
        let popUpViewController =
            BlockPopUpViewController(titleText: title,
                                     messageText: message,
    ...
    func showPopUp(contentView: UIView,
                   ...
                   leftActionCompletion: (() -> Void)? = nil,
                   rightActionCompletion: (() -> Void)? = nil) {
        let popUpViewController = BlockPopUpViewController(contentView: contentView)
    ...
    private func showPopUp(popUpViewController: BlockPopUpViewController,
